...
/* Generated from O.Common\DAQmxBase.dbd */
...
epicsShareExtern reg_func pvar_func_DAQmxBaseRegistrar,
...
int DAQmxBase_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* DAQmxBase_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"DAQmxBase_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    DAQmxBase_registerRecordDeviceDriver(*iocshPpdbbase);
}
