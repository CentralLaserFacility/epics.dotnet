...
/* Generated from src\LeyboldSimInclude.dbd */
...
epicsShareExtern reg_func pvar_func_LeyboldSimRegistrar,
...
int LeyboldSim_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* LeyboldSim_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"LeyboldSim_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    LeyboldSim_registerRecordDeviceDriver(*iocshPpdbbase);
}
