...
/* Generated from src\LeyboldTurboInclude.dbd */
...
epicsShareExtern rset *pvar_rset_aaiRSET, *pvar_rset_aaoRSET,
    *pvar_rset_aiRSET, *pvar_rset_aoRSET, *pvar_rset_asynRSET,
...
static const char * const recordTypeNames[] = {
    "aai", "aao", "ai", "ao", "asyn", "bi", "bo", "calc", "calcout",
...
epicsShareExtern reg_func pvar_func_LeyboldTurboRegistrar,
    ...
    pvar_func_drvAsynSerialPortRegisterCommands, pvar_func_syncInitialize,
...
int LeyboldTurbo_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "C:/epics/";
    ...
    pvar_func_LeyboldTurboRegistrar();
...
/* LeyboldTurbo_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"LeyboldTurbo_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    LeyboldTurbo_registerRecordDeviceDriver(*iocshPpdbbase);
}
